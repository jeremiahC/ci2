...
class AG_Auth_model extends CI_Model
{
	...
	public function register_teacher($username, $password, $email)
	{
		if($this->db->set('username', $username)->set('password', $password)->set('email', $email)->set('group_id', '2')->insert($this->user_table))
		{
			return TRUE;
		}
