<style>  
            ...
            $(this).ready( function() {  
                $("#id").autocomplete({  
                    ...
                    function(req, add){  
                        $.ajax({  
                            url: "<?php echo base_url(); ?>index.php/admin/crud/searchSpecial",  
                            dataType: 'json',  
                            type: 'POST',  
                            data: req,  
                            success:      
...
<div class="container-fluid bg-success text-center">
	<h2 class="text-success">Special Schedules</h2>
</div>
								...
								<!-- start comment modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/special_schedules_editComment");?>
								...
								<!-- start teacher modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/special_schedules_editTeacher");?>
								        	<div class="form-group">
											    	<label>Teacher</label>									    	
													 <?php
														$attributes = array (
								...
								<!-- start status modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/special_schedules_editStatus");?>
								        	<div class="form-group">
											    	<label>Status</label>
