<style>  
            ...
            $(this).ready( function() {  
                $("#id").autocomplete({  
                    ...
                    function(req, add){  
                        $.ajax({  
                            url: "<?php echo base_url(); ?>index.php/admin/crud/searchCourse3",  
                            dataType: 'json',  
                            type: 'POST',  
                            data: req,  
                            success:      
...
<div class="container-fluid bg-success text-center">
	<h2 class="text-success">Course Name 3 Schedules</h2>
</div>
								...
								<!-- start comment modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course3_editComment");?>
								...
								<!-- start teacher modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course3_editTeacher");?>
								        	<div class="form-group">
											    	<label>Teacher</label>									    	
													 <?php
														$attributes = array (
								...
								<!-- start status modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course3_editStatus");?>
								        	<div class="form-group">
											    	<label>Status</label>
