<style>  
            ...
            $(this).ready( function() {  
                $("#id").autocomplete({  
                    ...
                    function(req, add){  
                        $.ajax({  
                            url: "<?php echo base_url(); ?>index.php/admin/crud/searchVisitor",  
                            dataType: 'json',  
                            type: 'POST',  
                            data: req,  
                            success:      
...
<div class="container-fluid bg-success text-center">
	<h2 class="text-success">Visitor Schedules</h2>
</div>
...
<table class="table table-striped table-hover text-center">
		...
		<tr>
				  ...
				  <td><input></input></td>
				  <td>
				  		<?php echo form_open('admin/crud/visitor_schedulesStatus')?>
				  		<select name="status" onchange='this.form.submit()' >
				  			
				  			<option value="all">Show all</option>
				  			<option>Waiting for confirmation</option>
							<option>Aprroved</option>
								...
								<!-- start comment modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/visitor_schedules_editComment");?>
								...
								<!-- start teacher modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/visitor_schedules_editTeacher");?>
								        	<div class="form-group">
											    	<label>Teacher</label>									    	
													 <?php
														$attributes = array (
								...
								<!-- start status modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/visitor_schedules_editStatus");?>
								        	<div class="form-group">
											    	<label>Status</label>
