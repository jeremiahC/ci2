...
<div class="container-fluid bg-success text-center">
	<h2 class="text-success">Course Name 1 Schedules</h2>
</div>
								...
								<!-- start comment modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course1_editComment");?>
								...
								<!-- start teacher modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course1_editTeacher");?>
								        	<div class="form-group">
											    	<label>Teacher</label>									    	
													 <?php
														$attributes = array (
								...
								<!-- start status modal -->
								  ...
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<?php echo form_open("admin/crud/course1_editStatus");?>
								        	<div class="form-group">
											    	<label>Status</label>
