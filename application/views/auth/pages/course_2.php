<br>
		...
		<div class="panel-heading">Course Name 2</div>
		<div class="panel-body">
				...
				<?php }else{?>
				<div class="btn btn-primary pull-right" data-toggle="modal" data-target=".choose_my_schedule_modal2">Choose my schedule</div></td>
				<?php }?>
				</div>
		  ...
		  <tr class="lead">
				  ...
				  <?php foreach ($schedules2 as $schedule2){
								...
								<tr>
									<td><?php echo $schedule2['date'] ?></td>
									<td><?php echo $schedule2['time'] ?></td>
									<td><?php echo $schedule2['hours'] ?></td>
									<td>$ <?php echo $schedule2['price'] ?></td>
									<td>
									
									<div class="btn btn-primary btn-xs" data-toggle="modal" data-target=".enroll2-modal-<?php echo $schedule2['id'];?>">Enroll</div></td>
								</tr>
								
								
									<!-- start comment modal -->
		   						
		   						<div class="modal fade enroll2-modal-<?php echo $schedule2['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
								  <div class="modal-dialog modal-lg">
								      ...
								      <div class="modal-body">
								        	...
								        	<div class="form-group">
											    	<p><strong>Course :</strong> Course Name 2</p>
											    	<p><strong>Date :</strong> <?php echo $schedule2['date'] ?></p>
											    	<p><strong>Time :</strong> <?php echo $schedule2['time'] ?></p>
											    	<p><strong>No. of Hours :</strong> <?php echo $schedule2['hours'] ?></p>
											    	<p><strong>Price :</strong>$ <?php echo $schedule2['price'] ?></p>
												  ...
												  <input type="hidden" name="date" value="<?php echo $schedule2['date'] ?>">
												  <input type="hidden" name="time" value="<?php echo $schedule2['time'] ?>">
												  <input type="hidden" name="hours" value="<?php echo $schedule2['hours'] ?>">
												  <input type="hidden" name="price" value="<?php echo $schedule2['price'] ?>">
												  <input type="hidden" name="course_no" value="2">			  		
											</div>
											<?php }else{ ?>
													<?php echo form_open('course_enroll/visitor')?>
													<center>
													<h1 class="text-muted">Website name</h1>
													<input type="hidden" name="course" value="<?php echo $schedule2['course']; ?>">
													<input type="hidden" name="date" value="<?php echo $schedule2['date'] ?>">
												  	<input type="hidden" name="time" value="<?php echo $schedule2['time'] ?>">
												  	<input type="hidden" name="hours" value="<?php echo $schedule2['hours'] ?>">
												  	<input type="hidden" name="price" value="<?php echo $schedule2['price'] ?>">
				...
				<!-- start choose schedule modal -->
		   						...
		   						<div class="modal fade choose_my_schedule_modal2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
								  <div class="modal-dialog modal-lg">
									  <div class="modal-content">
									      <div class="modal-header">
									        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
